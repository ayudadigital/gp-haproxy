...
Docker image and docker-compose sample configuration to bring up a HAProxy Service to the [Docker Generic Platform (GP)](https://github.com/ayudadigital/docker-generic-platform).
